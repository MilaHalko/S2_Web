      ...
      379: (n) => {
        ...
        function t(n, t) {
          for (var a = {}, i = [], c = 0; c < n.length; c++) {
            ...
            if (-1 !== u) r[u].references++, r[u].updater(h);
            else {
              var g = o(h, t);
              (t.byIndex = c),
                r.splice(c, 0, { identifier: p, updater: g, references: 1 });
            }
            i.push(p);
          }
          return i;
  ...
  (e.m = n),
    ...
    (() => {
      ...
      const m = document.getElementById('myModal'),
        x = document.getElementById('myModalError'),
        f = document.getElementById('errMessage'),
        v = document.getElementsByClassName('close')[0];
      async function b(n, r, e) {
        return (
          await fetch('https://polite-jackal-95.hasura.app/v1/graphql', {
            headers: {
            ...
            method: 'POST',
            body: JSON.stringify({ query: n, variables: e, operationName: r }),
          })
        ).json();
      }
      const y =
      ...
      function k(n) {
        console.log(n.target.parentElement.parentElement.id),
          n.target.parentElement.parentElement.classList.add('animate'),
          document
          ...
          (m.style.display = 'block'),
            (v.onclick = function () {
              ...
              e.classList.add('note_info'),
                (e.innerHTML = document.getElementById('note_textarea').value),
                r.appendChild(e),
